...
namespace BizHawk.Emulation.Common
{
	...
	public class ControlDefUnMerger
	{
		...
		{
			private readonly IDictionary<string, string> _buttonAxisRemaps;
			...
			public DummyController(
				IController src,
				IDictionary<string, string> buttonAxisRemaps)
			{
				_src = src;
		...
		public IDictionary<string, string> _buttonAxisRemaps;

		public ControlDefUnMerger(IDictionary<string, string> buttonAxisRemaps)
		{
			_buttonAxisRemaps = buttonAxisRemaps;
		}
